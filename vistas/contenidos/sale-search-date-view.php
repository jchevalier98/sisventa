...
<div class="container-fluid">
	<ul class="breadcrumb breadcrumb-tabs">
        ...
        <li><a class="btn btn-info">/</a></li>
        <li class="active"><?php echo $lc->enrutador("venta_search_date", "buscar", 0); ?></li>
	</ul>
</div>
...
?> 
<div class="container-fluid"> 
	<form class="form-neon FormularioAjax" action="<?php echo SERVERURL; ?>ajax/buscadorAjax.php" data-form="desabilitar" method="POST" autocomplete="off" style="border: none; box-shadow:none; padding:15px">
