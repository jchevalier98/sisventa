<?php
	...
	class productoControlador extends mainModel{
        ...
        public function agregar_producto_controlador(){
            ...
            $producto_peso=mainModel::limpiar_cadena($_POST['producto_peso']);
            ...
            if($codigo=="" || $nombre=="" || $stock_total=="" || $producto_peso=="" || $unidad=="" || $precio_compra=="" || $precio_venta=="" || $descuento==""){
                $alerta=[
					"Alerta"=>"simple",
					...
					$tabla.='<li class="media media-product">';
						...
						$tabla.='<div class="media-body product-media-body">
							...
							<div class="container-fluid">
								<div class="row">
									<div class="col-12 col-md-6 col-lg-3 col-product"><i class="fas fa-barcode"></i> <strong>Código:</strong> '.$rows['producto_codigo'].'</div>
